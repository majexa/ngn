...
class XML_Tree_Node {
    ...
    */
    function XML_Tree_Node($name, $content = '', $attributes = []) {
    ...
    */
    function &addChild($child, $content = '', $attributes = []) {
    ...
    * @deprecated
    */
    function &add_child($child, $content = '', $attributes = []) {
    ...
    */
    function &insertChild($path,$pos,&$child, $content = '', $attributes = []) {
    ...
    * @deprecated
    */
    function &insert_child($path,$pos,&$child, $content = '', $attributes = []) {
