...
class DdBackup {
  ...
  static $maxBackupItems = 3;
  
  static $prefix = 'backup';
  ...
  static function save($strName, $pageId, $itemId) {
  ...
  static function getLast($strName, $pageId, $itemId) {
    return db()->selectRow("
  ...
  static function get($strName, $pageId, $itemId) {
    pr(self::$prefix);
    return db()->select("
      SELECT * FROM d?_".self::$prefix."_$strName
      WHERE pageId=?d AND id=?d ORDER BY dateBackup DESC",
  ...
  static function rollBack($strName, $pageId, $itemId, $dateBackup) {
    $item = db()->selectRow("
      SELECT * FROM d?_".self::$prefix."_$strName
