...
class Reporter2 {
  ...
  private $title;
	...
	function setMode($mode = 'rotates') {
		if (!in_array($mode, ['clicks', 'rotates', 'ctr']))  
  ...
  function setExtraCond($cond) {
    $this->extraCond .= "\n".$cond;
  }

  function resetExtraCond($cond) {
    $this->extraCond = "\n".$cond;
  }

  function setGroup($groupBy = null) {
