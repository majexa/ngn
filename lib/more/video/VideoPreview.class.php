...
class VideoPreview extends VideoFfmpeg {
   ...
   */
  function makePreview($videoFile, $w = 320, $h = 240, $type = 2) {
    if (!file_exists($videoFile))
      throw new Exception('File "'.$videoFile.'" does not exists');
  ...
  function getFrameStartTime($videoFile, $frameN, $framesCount) {
