...
class NgnUpdaterSingleSite {
  ...
  function __construct($urlBase, $ngnFolder) {
  ...
  private function newBuildExists() {
    prrr('Проверяем наличие нового билда по ссылке <a href="'.$this->urlBase.'/get-update.php" target="_blank">'.$this->urlBase.'/get-update.php</a>');
  ...
  private function getCurBuildN() {
    return Config::getConstant($this->ngnFolder.'/config/version.php', 'BUILD');
  }
