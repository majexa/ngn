...
class Arr {
   ...
   * @param string $k Ключ элемента подмассива, элемент которого необходимо использовать,
   *                  как элемент результирующего массива
   * @param null|string $kk Ключ элемента подмассива, значение которого необходимо
