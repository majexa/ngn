...
<center>
  <div class="loginAdmin">
    <h2><nobr><a href="<?= $this->getPath(0) ?>"><?= SITE_TITLE ?></a> — <?= LANG_ADMINISTRATION ?></nobr></h2>
    <? if (Auth::check()) { ?>
    ...
    <? } else { ?>
      ...
      <? } ?>
    <? } ?>
    <div class="copy"><small><?= Config::getVarVar('cpTheme', 'copyright') ?></small></div>
  </div>
</center>
...
<? } ?>
new Ngn.Form.factory('loginForm');
</script>
