<? $this->tpl('admin/modules/grabber/header', $d) ?>
...
?>" id="<?= 'item_'.$v['id'].'_'.$v['oid'] ?>">
  <td class="tools loader">
    ...
    <a href="<?= $this->getPath(3).'/edit?id='.$v['id'] ?>" class="iconBtn edit" title="Редактировать"><i></i></a>
    ...
    <? if (!$v['saveLinksFinished']) { ?>
      ...
      <div class="smIcons bordered"><a href="" class="delete deleteLinks" title="Очистить полученные ссылки"><i></i></a></div>
    <? } elseif (!$v['importAllFinished']) { ?>
      ...
      <div class="smIcons bordered"><a href="" class="delete deleteAllImported" title="Удалить импортированые записи"><i></i></a></div>
    <? } ?>
