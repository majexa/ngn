...
<? $this->tpl('common/errors', $d['errors']) ?>

<form action="<?= $this->getPath() ?>" method="post" id="strForm">
...
<div class="col">
  ...
  <p style="margin-top:15px"><input type="submit" value="<?= $d['action'] == 'edit' ? Locale::get('save') : Locale::get('create') ?>" style="width: 150px; height: 40px;"></p>
  </div>
  <div class="col">
  <p>
...
<div class="col">
  <p><b><?= Locale::get('description') ?>:</b></p>
