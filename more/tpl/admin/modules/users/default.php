<? //$this->tpl('admin/modules/users/header', $d) ?>
  ...
  <tr<?= $v['active'] ? '' : ' class="nonActive"'?> id="<?= 'item_'.$v['id'].'_10'?>">
    <td class="tools loader">
      ...
      <a class="iconBtn privileges" title="Привилегии"
        href="<?= $this->getPath(1) ?>/privileges?a=userPrivileges&userId=<?= $v['id'] ?>"><i></i></a>
      <? } ?>
      <a class="iconBtn <?= $v['active'] ? 'activate' : 'deactivate' ?>" title="<?= $v['active'] ? 'Скрыть' : 'Отобразить' ?>"
        href="<?= $this->getPath() ?>?a=<?= $v['active'] ? 'deactivate' : 'activate' ?>&id=<?= $v['id'] ?>"><i></i></a>
      <!--
      <a class="iconBtn subordination" title="Подчинение"
        href="<? $this->getPath(1) ?>subordination/<?= $v['id'] ?>"><i></i></a>
      -->
      <div class="clear"></div>
    </td>
    <td><?= $v['login'] ?></td>
