...
<? if ($d['page']['isLock']) { ?>
  <div class="error" style="width:400px;">
    ...
    <p>Вы можете <b><a class="confirm" href="<?= $this->getPath() ?>?a=unlockPage">снять это ограничение</a></b> или
    <a href="<?= $this->getPath().'?a=new' ?>">добавить пользователей с привилегией <b>view</b></a> для возможности просмотра ими этого раздела.</p>
  </div>
<? } else { ?>
  <div class="info" style="width:400px;">
    <div class="icon"><!-- --></div>
    <p><b>Просмотр раздела открыт</b></p>
    <p>Вы можете <b><a class="confirm" href="<?= $this->getPath() ?>?a=lockPage">ограничить доступ</a></b> к этому разделу.
...
<? } else { ?>
  <div class="iconsSet">
    <a href="<?= $this->getPath(2).'/'.$d['page']['id'].'/new' ?>" class="add gray"><i></i>Добавить привилегии для раздела <b><?= $d['page']['title'] ?></b></a>
    <div class="clear"><!-- --></div>
  </div>
<? } ?>