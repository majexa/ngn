...
<? } else { ?>
  <form action="<?= $this->getPath() ?>" method="post" id="loginForm">
  ...
  <div class="links">
    <!-- <a href="<? //$this->getControllerPath('password') ?>">Забыли пароль?</a>&nbsp;&nbsp;-->
    <a href="<?= $this->getControllerPath('userReg') ?>">Регистрация</a>
  </div>
