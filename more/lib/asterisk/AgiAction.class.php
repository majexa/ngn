...
/**
 * Объекты класса AgiAction вызываются не из контекста сайта, поэтому констант сайта таких,
 * как путь к конфигурации или настройки базы данных не существует. Поэтому связь с сайтом
 * осуществляется через демон очереди и добавление заданий в эту очередь
 */
