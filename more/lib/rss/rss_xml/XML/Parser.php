 ...
 */
require_once MORE_PATH.'/lib/rss/rss_xml/PEAR.php';
   ...
   /**
    ...
    function _initHandlers()
    {
        ...
        switch ($this->mode) {
            ...
            case 'func':
                ...
                xml_set_element_handler($this->parser, [&$this, 'funcStartHandler'], [&$this, 'funcEndHandler']);
                break;
    ...
    function funcStartHandler($xp, $elem, $attribs)
    {
        ...
        if (method_exists($this->_handlerObj, $func)) {
            ...
            call_user_func([&$this->_handlerObj, 'xmltag'], $xp, $elem, $attribs);
        }
    }
