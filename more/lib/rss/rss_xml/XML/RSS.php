...
require_once MORE_PATH.'/lib/rss/rss_xml/XML/Parser.php';
...
class XML_RSS extends XML_Parser {
   ...
   * @var array
   */
  var $itemTags = ['TITLE', 'LINK', 'DESCRIPTION', 'PUBDATE'];

  /**
   * @var array
   */
  var $imageTags = ['TITLE', 'URL', 'LINK'];
  ...
  function cdataHandler($parser, $cdata) {
    if (in_array($this->insideTag, $this->parentTags)) {
      ...
      if (in_array($this->activeTag, $var) || in_array($this->activeTag, $this->moduleTags)) {
