...
use Options;
  ...
  function typeJs() {
    ...
    Sflm::frontend('js')->addObject('Ngn.Form.ElInit.'.ucfirst($this->type), "$this->type field init");
    Sflm::frontend('js')->addObject('Ngn.Form.El.'.ucfirst($this->type), "$this->type field init");
