...
class LittleSms {
  ...
  const
    REQUEST_SUCCESS = 'success', REQUEST_ERROR = 'error', TYPE_DEFAULT = 0, TYPE_FLASH = 1, TYPE_PING = 2;

  protected $user = null, $key = null, $url = 'littlesms.ru/api', $useSSL = false, $response = null;
   ...
   */
  function __construct($user = null, $key = null, $useSSL = false) {
    $this->user = $user;
    $this->key = $key;
    $this->useSSL = $useSSL;
  }
   ...
   * @return int|bool
   */
  function blacklistAppend($phones, $description = null) {
   ...
   * @return int|bool
   */
  function blacklistDelete($phones) {
   ...
   * @return array|bool
   */
  function blacklistList($params = array()) {
   ...
   * @return bool|null
   */
  function senderCreate(array $params) {
   ...
   * @return bool|null
   */
  function senderConfirm($id, $code) {
   ...
   * @return bool|null
   */
  function senderList($params = array()) {
   ...
   * @return bool|null
   */
  function paymentCreate(array $params) {
   ...
   * @return bool|null
   */
  function paymentList($params = array()) {
   ...
   * @return bool|null
   */
  function signupRequest(array $params) {
   ...
   * @return bool|null
   */
  function signupConfirm($key, $code) {
    $this->makeAnonymousRequest('signup/confirm', array(
      'key'  => $key,
      'code' => $code
    ));
    return $this->getIfSuccess();
   ...
   * @return bool|null
   */
  function signupFinish($key, $code) {
    $this->makeAnonymousRequest('signup/finish', array(
      'key'  => $key,
      'code' => $code
    ));
    return $this->getIfSuccess();
   ...
   * @return bool|array
   */
  function bulkList($params = array()) {
   ...
   * @return boolean|integer
   */
  function bulkUpdate($id, array $params) {
   ...
   * @return boolean|integer
   */
  function messageSend($recipients, $message, $sender = null, $otherParams = array()) {
   ...
   */
  function messagePrice($recipients, $message) {
   ...
   * @deprecated
   */
  function messageHistory($params = array()) {
   ...
   * @return boolean|array
   */
  function messageList($params = array()) {
   ...
   * @return boolean|array
   */
  function contactList($params = array()) {
   ...
   * Контакты: создать
   *
   * @param array [$phone, $name = null, $description = null, $tags = array()]
   *
   * @return boolean|integer
   */
  function contactCreate(array $params) {
   ...
   * @return boolean|integer
   */
  function contactUpdate($id, array $params) {
   ...
   * @return boolean|integer
   */
  function tagCreate(array $params) {
   ...
   * @return boolean|integer
   */
  function tagUpdate($id, array $params) {
   ...
   * @return boolean|array
   */
  function taskList($params = array()) {
   ...
   * @return boolean|integer
   */
  function taskCreate(array $params) {
   ...
   * @return boolean|integer
   */
  function taskUpdate($id, array $params) {
   ...
   * @return array
   */
  function makeAnonymousRequest($function, array $params) {
    $params = $this->joinArrayValues($params);
    return $this->response = $this->httpRequest($function, $params);
  }
  ...
  protected function httpRequest($function, array $params) {
    ...
    if (function_exists('curl_init')) {
      ...
      LogWriter::v('littleSms', $response);
      curl_close($ch);
    }
    else {
    ...
    if (!empty($r['error'])) throw new Exception($r['message']);
    return $r;
  }
  ...
  function getIfSuccess($param = null) {
