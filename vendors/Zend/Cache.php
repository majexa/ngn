...
abstract class Zend_Cache
{
     ...
     * @var array
     */
    public static $standardBackends = ['File', 'Sqlite', 'Memcached', 'Apc', 'ZendPlatform', 'Xcache', 'TwoLevels'];
     ...
     * @var array
     */
    public static $standardExtendedBackends = ['File', 'Apc', 'TwoLevels', 'Memcached', 'Sqlite'];
     ...
     * @deprecated
     */
    public static $availableBackends = ['File', 'Sqlite', 'Memcached', 'Apc', 'ZendPlatform', 'Xcache', 'TwoLevels'];
