        ...
        foreach ($iniArray as $key => $data)
        {
            ...
            switch (count($bits)) {
                ...
                case 2:
                    ...
                    $preProcessedArray[$thisSection] = array_merge([';extends'=>$extendedSection], $data);
                    break;
        ...
        if (null === $section) {
            ...
            foreach ($preProcessedArray as $sectionName => $sectionData) {
                if(!is_array($sectionData)) {
                    $dataArray = array_merge_recursive($dataArray, $this->_processKey([], $sectionName, $sectionData));
                } else {
