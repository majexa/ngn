Ngn.PartialJob.Dialog = new Class({
  ...
  init: function() {
    ...
    //  this.eCheckboxContainer = Elements.from('<div class="checkbox"><input type="checkbox" id="checkbox1" /><label for="checkbox1">Повторять то же самое действие для всех последующих случаев</label></div>')[0].inject(this.message.getElement('.message-text'));
    ...
    if (this.options.autostart) this.startPj();
  },
