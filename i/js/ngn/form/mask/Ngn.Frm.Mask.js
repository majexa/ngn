// @requiresAfter Ngn.Frm.Mask.Extras, Ngn.Frm.Mask.Fixed
...
Ngn.Frm.Mask = new Class({
  ...
  dettach: function() {
    this.detach();
  }, // deprecated (incorrect syntax, sorry), use detach instead
  ...
  keydown: function(e, o) {
    this.ignore = (Ngn.Frm.Mask.ignoreKeys[e.code] && !o.isRemoveKey) || e.control || e.meta || e.alt;
    if (this.ignore || o.isRemoveKey) {
      var keyRepresentation = Ngn.Frm.Mask.ignoreKeys[e.code] || '';
      this.fireEvent('valid', [this.element, e.code, keyRepresentation]);
    }
    return (Ngn.Frm.Mask.onlyKeyDownRepeat && o.isRemoveKey) ? this.keypress(e, o) : true;
  },
  ...
  focus: function(e, o) {
    ...
    element.store('frmmask:focusvalue', element.get('value'));
  },

  blur: function(e, o) {
    var element = this.element;
    if (e && element.retrieve('frmmask:focusvalue') != element.get('value')) {
      element.fireEvent('change');
    }
  },

  getCurrentState: function(e, o) {
    var _char = String.fromCharCode(e.code), elValue = this.element.get('value');
  ...
  isFixedChar: function(_char) {
    return !Ngn.Frm.Mask.matchRules.contains(_char);
  },
...
Ngn.Frm.Mask.extend({
  ...
  onlyKeyDownRepeat: !!(Browser.ie || Browser.opera || Browser.chrome || (Browser.safari && Browser.version >= 4))
    ...
    var rules = {
      ...
      'h': {regex: /[0-9]/, check: Ngn.Frm.Mask.upTo(23)},
      'd': {regex: /[0-9]/, check: Ngn.Frm.Mask.upTo(31)},
      'm': {regex: /[0-9]/, check: Ngn.Frm.Mask.upTo(12)},
      '9': {regex: /[0-9]/}
    };
    return rules;
  })());
