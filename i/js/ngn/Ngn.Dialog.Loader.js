...
Ngn.Dialog.Loader_ = new Class({
  ...
  initBtns: function() {
    if (this.options.hasCloseBtn) {
      this.btnClose = Ngn.btn({
        title: this.options.btnCloseTitle,
        prop: {
          'events': {
            'click': function() {
              this.close();
    ...
    this.btnContinue = Ngn.btn({
      title: this.options.btnContinueTitle,
      prop: {
        'styles': {
          'margin-right': '10px',
          'display': 'none'
    ...
    this.btnClose2 = Ngn.btn({
      title: this.options.btnClose2Title,
      prop: {
        'styles': {
          'display': 'none'
        },
