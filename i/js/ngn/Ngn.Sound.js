...
Ngn.Sound.Player = new Class({
  ...
  init: function(sound) {
    ...
    this.playEl       = new Element('a', {'class':'play',  title:'Играть', id:'play'+this.i }).inject(this.controls);
    this.stopEl       = new Element('a', {'class':'stop',  title:'Стоп', id:'stop'+this.i }).inject(this.controls);
    this.pauseEl      = new Element('a', {'class':'pause', title:'Пауза', id:'pause'+this.i}).inject(this.controls);
