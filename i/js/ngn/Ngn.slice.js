...
Ngn.slice.Layout = new Class({
  ...
  initialize: function() {
    if (Ngn.layout.isHome() && Ngn.layout.homeTopOffset) this.offsetY = Ngn.layout.homeTopOffset;
    this.initElements();
    this.initEdit();
  },
...
Ngn.slice.Absolute = new Class({
  ...
  initialize: function(sliceEdit) {
    ...
    var btnMove = this.sliceEdit.eEditBlock.getElement('.move');
...
Ngn.slice.Edit = new Class({
  ...
  initialize: function(container) {
    ...
    this.btnEdit = this.eEditBlock.getElement('.edit');
    this.initEditBtn();
