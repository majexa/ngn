var vSound2 = new Class({
  ...
  var options = {
    'onRegister': function() {
      ...
      this.playEl       = new Element('a', {'class':'play',  title:'123', id:'play'+i }).inject(this.controls);
      this.stopEl       = new Element('a', {'class':'stop',  title:'?123', id:'stop'+i }).inject(this.controls);
      this.pauseEl      = new Element('a', {'class':'pause', title:'?123', id:'pause'+i}).inject(this.controls);
