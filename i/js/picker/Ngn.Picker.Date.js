...
(function () {
  ...
  /**
   * DatePicker — это аккуратный модульный и стилизуемый DatePicker.
   * Он имеет много функций и опций таких как режим выбора только дня,
   * месяца или времени; минимальных и максимальных дат, локализации и других.
   */
  Ngn.Picker.Date = new Class({

    Extends: Ngn.Picker.Attach,
...
// Renderers only output elements and calculate the limits!
  ...
  Ngn.Picker.Date.defineRenderer = function (name, fn) {
    renderers[name] = fn;
    return this;
  };
